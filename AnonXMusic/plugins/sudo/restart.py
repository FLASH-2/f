...
@app.on_message(filters.command(["/getlog","getlog","/logs","logs","/getlogs","getlogs","السجل"],"") & SUDOERS)
@language
...
@app.on_message(filters.command(["/update","/gitpull","update", "gitpull","تحديث"],"") & SUDOERS)
@language
